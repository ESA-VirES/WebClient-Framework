...
var VECTOR_BREAKDOWN = {
    ...
    'B_NEC_SIFM': ['B_N_SIFM','B_E_SIFM','B_C_SIFM'],
    'B_NEC_IGRF12': ['B_N_IGRF12','B_E_IGRF12','B_C_IGRF12'],
    'B_NEC_CHAOS-6-Combined': ['B_N_CHAOS-6-Combined','B_E_CHAOS-6-Combined','B_C_CHAOS-6-Combined'],
    'B_NEC_Custom_Model': ['B_N_Custom_Model','B_E_Custom_Model','B_C_Custom_Model'],
    'B_NEC_MCO_SHA_2C': ['B_N_MCO_SHA_2C','B_E_MCO_SHA_2C','B_C_MCO_SHA_2C'],
    'B_NEC_MCO_SHA_2D': ['B_N_MCO_SHA_2D','B_E_MCO_SHA_2D','B_C_MCO_SHA_2D'],
    'B_NEC_MCO_SHA_2F': ['B_N_MCO_SHA_2F','B_E_MCO_SHA_2F','B_C_MCO_SHA_2F'],
    'B_NEC_MLI_SHA_2C': ['B_N_MLI_SHA_2C','B_E_MLI_SHA_2C','B_C_MLI_SHA_2C'],
    'B_NEC_MLI_SHA_2D': ['B_N_MLI_SHA_2D','B_E_MLI_SHA_2D','B_C_MLI_SHA_2D'],
    'B_NEC_MMA_SHA_2C-Primary': ['B_N_MMA_SHA_2C-Primary','B_E_MMA_SHA_2C-Primary','B_C_MMA_SHA_2C-Primary'],
    'B_NEC_MMA_SHA_2C-Secondary': ['B_N_MMA_SHA_2C-Secondary','B_E_MMA_SHA_2C-Secondary','B_C_MMA_SHA_2C-Secondary'],
    'B_NEC_MMA_SHA_2F-Primary': ['B_N_MMA_SHA_2F-Primary','B_E_MMA_SHA_2F-Primary','B_C_MMA_SHA_2F-Primary'],
    'B_NEC_MMA_SHA_2F-Secondary': ['B_N_MMA_SHA_2F-Secondary','B_E_MMA_SHA_2F-Secondary','B_C_MMA_SHA_2F-Secondary'],
    'B_NEC_CHAOS-6-MMA-Primary': ['B_N_CHAOS-6-MMA-Primary','B_E_CHAOS-6-MMA-Primary','B_C_CHAOS-6-MMA-Primary'],
    'B_NEC_CHAOS-6-MMA-Secondary': ['B_N_CHAOS-6-MMA-Secondary','B_E_CHAOS-6-MMA-Secondary','B_C_CHAOS-6-MMA-Secondary'],
    'B_NEC_MIO_SHA_2C-Primary': ['B_N_MIO_SHA_2C-Primary','B_E_MIO_SHA_2C-Primary','B_C_MIO_SHA_2C-Primary'],
    'B_NEC_MIO_SHA_2C-Secondary': ['B_N_MIO_SHA_2C-Secondary','B_E_MIO_SHA_2C-Secondary','B_C_MIO_SHA_2C-Secondary'],
    'B_NEC_MIO_SHA_2D-Primary': ['B_N_MIO_SHA_2D-Primary','B_E_MIO_SHA_2D-Primary','B_C_MIO_SHA_2D-Primary'],
    'B_NEC_MIO_SHA_2D-Secondary': ['B_N_MIO_SHA_2D-Secondary','B_E_MIO_SHA_2D-Secondary','B_C_MIO_SHA_2D-Secondary'],
