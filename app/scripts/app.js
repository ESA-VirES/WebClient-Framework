...
var RELATED_VARIABLES = {
  ...
  'MIT_LP': ['Ne', 'Te', 'N_ion=Ne', 'N_elec=Ne', 'T_elec=Te'].concat(_COMMON_RELATED_VARIABLES),
  'MIT_LP:ID': ['Ne', 'Te', 'N_ion=Ne', 'N_elec=Ne', 'T_elec=Te', 'PointType'].concat(_COMMON_RELATED_VARIABLES),
    ...
    var Application = Backbone.Marionette.Application.extend({
      ...
      configure: function (config) {
        ...
        globals.swarm.products = {
          ...
          "TEC": {
            "Alpha": "SW_OPER_TECATMS_2F+SW_FAST_TECATMS_2F",
            "Bravo": "SW_OPER_TECBTMS_2F+SW_FAST_TECBTMS_2F",
            "Charlie": "SW_OPER_TECCTMS_2F+SW_FAST_TECCTMS_2F",
